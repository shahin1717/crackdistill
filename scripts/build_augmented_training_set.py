...
def copy_base_dataset():
    ...
    # Ensure dataset.yaml points to OUT_DIR, not SRC_YOLO
    yaml_content = f"""# Crack500 Augmented — YOLO seg format
# Auto-generated by build_augmented_training_set.py
...
"""
    ...
    print(f"[Base] Copied {SRC_YOLO} -> {OUT_DIR} and updated dataset.yaml")
